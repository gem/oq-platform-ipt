...
*/
    ...
    $(cf_obj['vol'].pfx + ' div[name="lavaflow-input"] select[name="in-type"]').val('text').triggerHandler('change');
    $(cf_obj['vol'].pfx + ' div[name="lahar-input"] select[name="in-type"]').val('text').triggerHandler('change');
    $(cf_obj['vol'].pfx + ' div[name="pyroclasticflow-input"] select[name="in-type"]').val('text').triggerHandler('change');
